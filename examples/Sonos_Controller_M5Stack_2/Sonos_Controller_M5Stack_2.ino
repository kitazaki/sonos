...
// Living room
String ipaddress = "192.168.13.6";
IPAddress g_KitchenIP(192, 168, 13, 6);
...
uint16_t offset_x = 0;
uint16_t offset_y = 0;
jpeg_div_t scale = JPEG_DIV_4; // JPEG_DIV_NONE, JPEG_DIV_2, JPEG_DIV_4, JPEG_DIV_8
...
void setup()
{
  ...
  M5.Lcd.fillTriangle(35,210,50,190,50,230,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(55,210,70,190,70,230,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(265,210,250,190,250,230,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(285,210,270,190,270,230,M5.Lcd.color565(255, 255, 255));
