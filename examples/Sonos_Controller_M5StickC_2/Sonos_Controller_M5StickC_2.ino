...
void setup()
{
  ...
  M5.begin();
  M5.MPU6886.Init();
  M5.Lcd.setRotation(0); // display size = 80x160, setRotation = 0:M5, 1:Power Btn, 2:up side down, 3:Btn
...
//  M5.Lcd.setTextSize(2);
  ...
  M5.Lcd.fillRect(36,66,3,10,M5.Lcd.color565(255, 255, 255)); // (x,y,w,h)
  M5.Lcd.fillRect(41,66,3,10,M5.Lcd.color565(255, 255, 255)); // (x,y,w,h)
  M5.Lcd.fillTriangle(8,70,12,63,12,76,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(13,70,17,63,17,76,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(66,70,62,63,62,76,M5.Lcd.color565(255, 255, 255));
  M5.Lcd.fillTriangle(71,70,67,63,67,76,M5.Lcd.color565(255, 255, 255));
...
//      M5.Lcd.setTextSize(2);
      ...
      M5.Lcd.fillTriangle(41,70,37,63,37,76,M5.Lcd.color565(255, 255, 255));
      M5.Lcd.fillTriangle(8,70,12,63,12,76,M5.Lcd.color565(255, 255, 255));
      M5.Lcd.fillTriangle(13,70,17,63,17,76,M5.Lcd.color565(255, 255, 255));
      M5.Lcd.fillTriangle(66,70,62,63,62,76,M5.Lcd.color565(255, 255, 255));
      M5.Lcd.fillTriangle(71,70,67,63,67,76,M5.Lcd.color565(255, 255, 255));
...
//  Serial.printf("%7.2f,%7.2f,%7.2f\n", gyroX * M5.MPU6886.gRes, gyroY * M5.MPU6886.gRes, gyroZ * M5.MPU6886.gRes);
  ...
  if (gyroY * M5.MPU6886.gRes < -50) {
    g_sonos.skip(g_KitchenIP, SONOS_DIRECTION_BACKWARD);
  } else if (gyroY * M5.MPU6886.gRes > 50) {
    g_sonos.skip(g_KitchenIP, SONOS_DIRECTION_FORWARD);
  }
